...
const DEFAULT_CATEGORY_GROUPS = {
  ...
  despesasOperacionais: ['PRO LABORE','SALÁRIOS','COLABORADOR 1','COLABORADOR 2','COLABORADOR 3','ALUGUEL','ÁGUA','LUZ','INTERNET','CONDOMÍNIO','IPTU','SEGURO INCÊNDIO','TAXA BOLETO ALUGUEL','ESTACIONAMENTO','BENS DURÁVEIS DE PEQUENO VALOR','MATERIAL DE CONSUMO','MATERIAL ESCRITÓRIO - CONSUMÍVEIS','SERVIÇOS E MATERIAL DE LIMPEZA','MANUTENÇÃO - SERVIÇOS','MANUTENÇÃO - MATERIAIS','CONTABILIDADE','TFE','INSS','DARF','FGTS'],
